...
const (
	MLService_Roast_FullMethodName = "/ml.MLService/Roast"
)
...
type MLServiceClient interface {
	Roast(ctx context.Context, in *RoastRequest, opts ...grpc.CallOption) (*RoastResponse, error)
}
...
func (c *mLServiceClient) Roast(ctx context.Context, in *RoastRequest, opts ...grpc.CallOption) (*RoastResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoastResponse)
	err := c.cc.Invoke(ctx, MLService_Roast_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MLServiceServer interface {
	Roast(context.Context, *RoastRequest) (*RoastResponse, error)
...
func (UnimplementedMLServiceServer) Roast(context.Context, *RoastRequest) (*RoastResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Roast not implemented")
}
...
func _MLService_Roast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RoastRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MLServiceServer).Roast(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MLService_Roast_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MLServiceServer).Roast(ctx, req.(*RoastRequest))
	}
...
var MLService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Roast",
			Handler:    _MLService_Roast_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/proto/ml/ml.proto",
}
